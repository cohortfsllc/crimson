...
pkg_check_modules(PKGCONFIG_CAPNP capnp QUIET)
...
if(CAPNP_FOUND)
	if(NOT TARGET Capnp::Lite)
		add_library(Capnp::Lite INTERFACE IMPORTED)
		set_target_properties(Capnp::Lite PROPERTIES
			INTERFACE_COMPILE_OPTIONS "${CAPNP_DEFINITIONS}"
			INTERFACE_INCLUDE_DIRECTORIES "${CAPNP_INCLUDE_DIRS}"
			INTERFACE_LINK_LIBRARIES "${CAPNP_LIBRARIES_LITE}")
	endif()
	if(NOT TARGET Capnp::Capnp)
		add_library(Capnp::Capnp INTERFACE IMPORTED)
		set_target_properties(Capnp::Capnp PROPERTIES
			INTERFACE_COMPILE_OPTIONS "${CAPNP_DEFINITIONS}"
			INTERFACE_INCLUDE_DIRECTORIES "${CAPNP_INCLUDE_DIRS}"
			INTERFACE_LINK_LIBRARIES "${CAPNP_LIBRARIES}")
	endif()
endif()
